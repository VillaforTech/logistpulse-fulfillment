...
La creación HTTP y los health checks no prueban la promesa READY <=15s. Publicar directamente a Kafka después de guardar el pedido deja una ventana de pérdida; consumir solo los últimos 20 pedidos omite población de los KPIs. El alcance aprobado del proyecto incluye recuperación y streaming real.
