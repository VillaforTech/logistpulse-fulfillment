...
Ver [contratos y límites de frescura](../docs/business-kpis.md) y [recuperación](../docs/business-events.md). El benchmark con cien observaciones reales guarda su resultado y capturas bajo `artifacts/streaming`.
